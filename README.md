...
1. Clone the repository with `git clone git@github.com:dattatrayvaze/shopy-core.git`
2. Change directory to your project folder `cd shopy-core`
3. Install the dependencies with `npm install`
4. Create database in MySQL. `shopydb`
